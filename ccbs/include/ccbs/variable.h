...
namespace optimization {
    ...
    public:
        SplittedVariable(char const * name, AuxiliaryVariable* aux);
        ~SplittedVariable();
    ...
    public:
        AuxiliaryVariable(char const * name, int index);
        ~AuxiliaryVariable();
        void process(Matrix& calculated_solution, Matrix& solution, int index);
    private:
        int index;
