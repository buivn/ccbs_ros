...
private:
    ...
    std::unordered_map<int, Node> close; // associative container that contains key-value with unique keys. 
    // The element in the map is not sorted in any order
    std::list<Node> open;  // std::list - usually do in dual linkly-list
