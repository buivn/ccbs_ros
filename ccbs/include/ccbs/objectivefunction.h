...
#include <ccbs/pilalexceptions.h>
...
namespace optimization {
    ...
    class ObjectiveFunction {
        ...
        public:
            ...
            ObjectiveFunctionType getType();
            void updateCosts(Matrix new_cost);
            void updateType(ObjectiveFunctionType new_type);
            void makeCosts_empty();
