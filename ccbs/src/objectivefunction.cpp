...
#include <ccbs/objectivefunction.h>
...
namespace optimization {
	...
	*/
    ...
    Matrix ObjectiveFunction::getCosts() const {
    	return costs;
    }
    ObjectiveFunctionType ObjectiveFunction::getType() {
    	return type;
    }
    void ObjectiveFunction::updateCosts(Matrix new_cost) {
    	costs = new_cost;
    }

    void ObjectiveFunction::makeCosts_empty() {
    	costs.empty();
    }

    void ObjectiveFunction::updateType(ObjectiveFunctionType new_type) {
    	type = new_type;
    }
